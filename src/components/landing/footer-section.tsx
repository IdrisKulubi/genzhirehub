...
export default function FooterSection() {
  ...
  return (
    <footer className="bg-gradient-to-br from-rose-50/30 via-pink-50/20 to-rose-50/30 dark:from-gray-900 dark:via-rose-950/10 dark:to-pink-950/10 border-t border-rose-200/50 dark:border-rose-800/30">
      <div className="container mx-auto px-4 py-12">
            ...
            <ul className="space-y-2">
              {footerLinks.product.map((link, index) => (
                <li key={index}>
                  <Link
                    href={link.href}
                    className="text-gray-600 dark:text-gray-300 hover:text-rose-600 dark:hover:text-rose-400 transition-colors text-sm"
                  >
                    {link.name}
                  </Link>
                </li>
        ...
        {/* Bottom Section */}
        <div className="border-t border-rose-200/50 dark:border-rose-700/30 pt-8">
